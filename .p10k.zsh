# Generated by Powerlevel10k configuration wizard on 2019-11-22 at 10:47 PST.
...
# slanted separators, blurred heads, slanted tails, 2 lines, dotted, left frame, dark,
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=246
  # Make the icon bold.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=244
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=65
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=233
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=66
  ...
  typeset -g POWERLEVEL9K_NODENV_BACKGROUND=59
  ...
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=59
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_NODEENV_BACKGROUND=59
  ...
  typeset -g POWERLEVEL9K_NODE_VERSION_BACKGROUND=59
  ...
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND=145
  ...
  #################[ rust_version: rustc version (https://www.rust-lang.org) ]##################
  # Rust version color.
  typeset -g POWERLEVEL9K_RUST_VERSION_FOREGROUND=140
  typeset -g POWERLEVEL9K_RUST_VERSION_BACKGROUND=61
  ...
  ###############[ dotnet_version: .NET version (https://dotnet.microsoft.com) ]################
  # .NET version color.
  typeset -g POWERLEVEL9K_DOTNET_VERSION_FOREGROUND=133
  typeset -g POWERLEVEL9K_DOTNET_VERSION_BACKGROUND=56
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND=131
  typeset -g POWERLEVEL9K_RVM_BACKGROUND=59
